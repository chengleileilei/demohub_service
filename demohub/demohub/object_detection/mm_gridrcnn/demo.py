...
def main():
    ...
    res_image_name = 'grid_rcnn_' + image_name
    
    out_file = os.path.join(image_dir,res_image_name)

    config_file = class_dir+'/mmdetection/configs/grid_rcnn/grid_rcnn_r50_fpn_gn-head_2x_coco.py'
    # 从 model zoo 下载 checkpoint 并放在 `checkpoints/` 文件下
    # 网址为: http://download.openmmlab.com/mmdetection/v2.0/faster_rcnn/faster_rcnn_r50_fpn_1x_coco/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth
    checkpoint_file = class_dir+'/mmdetection/checkpoints/grid_rcnn_r50_fpn_gn-head_2x_coco_20200130-6cca8223.pth'
