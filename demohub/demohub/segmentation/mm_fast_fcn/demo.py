...
def main():
    ...
    config_file = class_dir+'/mmsegmentation/configs/fastfcn/fastfcn_r50-d32_jpu_aspp_512x1024_80k_cityscapes.py'
    ...
    checkpoint_file = class_dir+'/mmsegmentation/checkpoints/fastfcn_r50-d32_jpu_aspp_512x1024_80k_cityscapes_20210928_053722-5d1a2648.pth'
