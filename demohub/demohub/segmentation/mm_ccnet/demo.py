...
def main():
    ...
    res_image_name = 'ccnet_' + image_name
    
    out_file = os.path.join(image_dir,res_image_name)

    config_file = class_dir+'/mmsegmentation/configs/ccnet/ccnet_r50-d8_512x1024_40k_cityscapes.py'
    ...
    checkpoint_file = class_dir+'/mmsegmentation/checkpoints/ccnet_r50-d8_512x1024_40k_cityscapes_20200616_142517-4123f401.pth'
